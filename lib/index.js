...
class mpesa {
     ...
     */
    b2c(InitiatorName, Amount, PartyA, PartyB, QueueTimeOutURL, ResultURL, CommandID = 'BusinessPayment', Occasion = 'Business To Customer Request', Remarks = 'Business To Customer Request') {
     ...
     */
    b2b(InitiatorName, Amount, PartyA, PartyB, AccountReference, QueueTimeOutURL, ResultURL, CommandID = 'MerchantToMerchantTransfer', SenderIdentifierType = 4, RecieverIdentifierType = 4, Remarks = 'Business To Business Request') {
        return new Promise((resolve, reject) => {
            const data = {
                InitiatorName: InitiatorName,
                SecurityCredential: this.securitycredential,
     ...
     * @returns {Promise}
     */
    c2bregister(ShortCode, ConfirmationURL, ValidationURL, ResponseType = 'Completed') {
        return new Promise((resolve, reject) => {
            const data = {
                ShortCode: ShortCode,
     ...
     * @returns {Promise} Promise
     */
    c2bsimulate(ShortCode, Amount, Msisdn, CommandID = 'CustomerPayBillOnline', BillRefNumber = null) {
        return new Promise((resolve, reject) => {
            const data = {
                ShortCode: ShortCode,
                CommandID: CommandID,
     ...
     * @returns {Promise}
     */
    accountBalance(Initiator, PartyA, IdentifierType, QueueTimeOutURL, ResultURL, CommandID = 'AccountBalance', Remarks = 'Check Account Balance') {
        return new Promise((resolve, reject) => {
            const data = {
                Initiator: Initiator,
                SecurityCredential: this.securitycredential,
    ...
    transactionStatus(Initiator, TransactionID, PartyA, IdentifierType, ResultURL, QueueTimeOutURL, CommandID = 'TransactionStatusQuery', Remarks = 'Transaction Reversal', Occasion = 'TransactionReversal') {
        return new Promise((resolve, reject) => {
            const data = {
                Initiator: Initiator,
                SecurityCredential: this.securitycredential,
     ...
     */
    reversal(Initiator, TransactionID, Amount, ReceiverParty, ResultURL, QueueTimeOutURL, CommandID = 'TransactionReversal', RecieverIdentifierType = 11, Remarks = 'Remarks', Occasion = 'Reversal') {
        return new Promise((resolve, reject) => {
            const data = {
                Initiator: Initiator,
                SecurityCredential: this.securitycredential,
     ...
     * @returns {Promise}
     */
    lipanampesa(BusinessShortCode, Amount, PartyA, PhoneNumber, CallBackURL, AccountReference, passKey, TransactionType = 'CustomerPayBillOnline', TransactionDesc = 'Lipa Na Mpesa Online') {
        return new Promise((resolve, reject) => {
     ...
     * @returns {Promise}
     */
    lipanampesaquery(BusinessShortCode, CheckoutRequestID, passKey) {
        return new Promise((resolve, reject) => {
            const Timestamp = new Date()
                .toISOString()
                .replace(/[^0-9]/g, '')
